\\021\000\007\000\022\000\006\000\023\000\005\000\024\000\004\000\
\\025\000\003\000\026\000\002\000\027\000\001\000\000\000\
\\000\000\
\\001\000\145\000\011\000\014\000\015\000\013\000\016\000\012\000\
\\017\000\011\000\018\000\010\000\019\000\009\000\020\000\008\000\
\\021\000\007\000\022\000\006\000\023\000\005\000\024\000\004\000\
\\025\000\003\000\026\000\002\000\027\000\001\000\000\000\
\\000\000\
...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | ID of unit ->  (string) | lvaluetail of unit ->  (lvalueVar list)
 ...
 | dec of unit ->  (A.dec) | decs of unit ->  (A.dec)
...
) => let val  result = MlyValue.literal (fn _ => let val  INT1 = INT1
 ()
 in (A.NilExp)
end)
...
explistsemi1, _, _)) :: ( _, ( _, LPAREN1left, _)) :: rest671)) => let
 val  result = MlyValue.sequence (fn _ => let val  explistsemi1 = 
explistsemi1 ()
 in (A.NilExp)
end)
...
result = MlyValue.assignment (fn _ => let val  lvalue1 = lvalue1 ()
 val  exp1 = exp1 ()
 in (A.NilExp)
end)
...
rest671)) => let val  result = MlyValue.forstm (fn _ => let val  ID1 =
 ID1 ()
 val  exp1 = exp1 ()
 val  exp2 = exp2 ()
 val  exp3 = exp3 ()
...
MlyValue.letstm (fn _ => let val  decs1 = decs1 ()
 in (A.NilExp)
end)
 in ( LrTable.NT 23, ( result, LET1left, END1right), rest671)
end
...
MlyValue.typelist (fn _ => let val  ID1 = ID1 ()
 val  exp1 = exp1 ()
 in (A.NilExp)
end)
...
MlyValue.ID ID1, _, _)) :: _ :: ( _, ( MlyValue.typelist typelist1, 
typelist1left, _)) :: rest671)) => let val  result = MlyValue.typelist
...
) => let val  result = MlyValue.explistsemi (fn _ => let val  exp1 = 
exp1 ()
 in (A.NilExp)
end)
...
) => let val  result = MlyValue.explistcomma (fn _ => let val  exp1 = 
exp1 ()
 in ()
end)
...
MlyValue.decs (fn _ => let val  decs1 = decs1 ()
 val  dec1 = dec1 ()
 in (A.NilExp)
end)
...
tyfield1right)) :: rest671)) => let val  result = MlyValue.tyfields
 (fn _ => let val  tyfield1 = tyfield1 ()
 in (A.NilExp)
end)
...
) => let val  result = MlyValue.tyfields (fn _ => let val  tyfields1 =
 tyfields1 ()
...
, _)) :: rest671)) => let val  result = MlyValue.lvaluetail (fn _ =>
 ...
 in ( LrTable.NT 27, ( result, DOT1left, ID1right), rest671)
end
|  ( 72, ( ( _, ( _, _, RBRACK1right)) :: ( _, ( MlyValue.exp exp1, _,
 _)) :: ( _, ( _, LBRACK1left, _)) :: rest671)) => let val  result = 
MlyValue.lvaluetail (fn _ => let val  exp1 = exp1 ()
 in (A.NilExp)
end)
