...
fun yyQ24 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction25(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ87(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
...
fun yyQ20 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction7(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ90(strm', yyMATCH(strm, yyAction7, yyNO_MATCH))
...
fun yyQ18 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction19(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ92(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
...
fun yyQ16 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction17(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"-"
              then yyQ93(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
       ...
       of NONE => yyAction1(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\v"
              ...
              then if inp <= #"\b"
                  then yyAction1(strm, yyNO_MATCH)
                  else yyQ95(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
            else if inp = #" "
       ...
       of NONE => yyAction0(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\v"
              ...
              then if inp <= #"\b"
                  then yyAction0(strm, yyNO_MATCH)
                  else yyQ95(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
            else if inp = #" "
...
fun yyQ4 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction5(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ5(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
