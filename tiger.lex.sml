        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction49(strm, yyNO_MATCH)
                      else yyQ48(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction49(strm, yyNO_MATCH)
                  else yyQ48(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp = #"e"
       ...
       of NONE => yyAction26(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ93(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
...
fun yyQ23 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction22(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ10(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
