...
fun yyQ72 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ59(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ59(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
                else if inp < #"0"
...
fun yyQ102 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction54(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ59(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #"0"
                  then yyQ59(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                else if inp < #"0"
       ...
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"a"
                  then yyQ101(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
                  else yyAction55(strm, yyNO_MATCH)
            else if inp <= #"z"
              then yyQ59(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
              else yyAction55(strm, yyNO_MATCH)
        ...
        | SOME(inp, strm') =>
            if inp = #"\\"
              ...
              then if inp = #"\v"
                  ...
                  then if inp <= #"\b"
                      then yyQ14(strm', yyMATCH(strm, yyAction9, yyNO_MATCH))
                      else yyQ15(strm', yyMATCH(strm, yyAction9, yyNO_MATCH))
                else if inp = #" "
                  then yyQ15(strm', yyMATCH(strm, yyAction9, yyNO_MATCH))
                  else yyQ14(strm', yyMATCH(strm, yyAction9, yyNO_MATCH))
            else if inp = #"g"
              then yyQ14(strm', yyMATCH(strm, yyAction9, yyNO_MATCH))
            else if inp < #"g"
              then if inp = #"f"
            ...
            if inp = #"\\"
              ...
              then if inp = #"!"
                  ...
                  then if inp = #"\v"
                      ...
                      then if inp <= #"\b"
                          then yyAction11(strm, yyNO_MATCH)
                          else yyQ6(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
                    else if inp = #" "
                      then yyQ6(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
